--
-- Introduces guide group and guide stars.
--


--
-- An enumeration of the available guide probes and guide windows along with
...
CREATE TABLE e_guider (
  ...
  UNIQUE (id, instrument) -- FK referent from guide_star
);
...
CREATE TABLE guide_star (
  ...
  guider_instrument identifier              REFERENCES e_instrument,
  ...
  UNIQUE (group_id, guider), -- No group should have more than one guide star assigned to a particular probe
